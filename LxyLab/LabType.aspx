<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LabType.aspx.cs" Inherits="LxyLab.LabType1" %>
    ...
    <script type="text/javascript">
        $(function () {
            $("#userOrder-dg").datagrid({
                url: 'GetLabTypeList.ashx', pagination: true,
                columns: [[
                           { field: 'LabTypeID', title: '编号', checkbox: true },
                           { field: 'LabTypeName', title: '一级分类名' }, 
                           {
                               field: '_LabTypeID', title: '操作', align: 'center', formatter: function (value, rowData, rowIndex) {
                                   ...
                                   //+ '" >详细</a>'
                                   '<a herf="javascript:void(0)" class="easyui-linkbutton edit-dl-btn"  data-options="iconCls:\'icon-page_edit\' ,plain:true" data-id="' + rowData.LabTypeID
                                   + '" >修改</a>' +
                                   '<a herf="javascript:void(0)" class="easyui-linkbutton delete-dl-btn"  data-options="iconCls:\'icon-delete\',plain:true" data-id="' + rowData.LabTypeID
                                   + '" >删除</a>'
                ...
                toolbar: [
                   {
                       ...
                       handler: function () {
                           $this = $(this);
                           sr.dialog.form("EditLabType.aspx",
                    ...
                    */
                    $(".delete-dl-btn").linkbutton().on("click", function () {
                        ...
                        $.messager.confirm("请确认", "您确定要删除？", function (b) {
                            if (b) {
                                $.post("DeleteLabType.ashx", { id: parseInt($this.attr("data-id")) }, function (data) {
